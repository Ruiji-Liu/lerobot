lerobot-train \
  --dataset.repo_id=/home/ubuntu/LeForge/Data/Postprocess_lerobot/pick_cubes_eef_rot6d_relative_30 \
  ...
  --batch_size=16 \
  --steps=2000000 \
  --output_dir=outputs/train_relative/pick_cubes_relative_30_0401 \
  --job_name=pick_cubes \
  --policy.device=cuda \
  --wandb.enable=false \
  --log_freq=20 \
